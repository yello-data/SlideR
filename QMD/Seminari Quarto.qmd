...
# 2. Elements principals de Quarto {background-color="#e8e8e8"}
...
[^5]: Molt útil per fer [documents interactius](https://bookdown.org/yihui/rmarkdown/params-knit.html#params-knit){target="_blank"} per establir els paràmetres de base.
