...
-   [https://jmas.quarto.pub/analisi-bivariada-cat/](https://jmas.quarto.pub/analisi-bivariada-cat/){target="_blank"}
...
-   Marc de dades: tibble, kable, datatable^[Sempre utilitzar `head()`!].
