...
Gairebé sempre, una gràfica creada amb ggplot2 consisteix en **tres capes**^[Layers are separated by `+`, not by a pipe!!!!]:
...
**Estètics**: representen una variable. Always within the `aes()` function. E.g.:
