...
id <- read_csv2("new/t15903201900.csv", skip = 5) |> 
  clean_names()
...
write_rds(lloguer, "new/lloguer_any.rds")
...
write_rds(rendacs, "new/rendacs.rds")
...
write_rds(accidents20, "new/accidents.rds")
...
write_rds(cm18, "new/contractes_menors.rds")
...
write_rds(festivals21, "new/festivals.rds")
...
cens_gc <- read_csv("new/Cens_de_persones_desaparegudes_durant_la_Guerra_Civil.csv") |> 
  clean_names()
write_rds(cens_gc, "new/cens_gc.rds")
