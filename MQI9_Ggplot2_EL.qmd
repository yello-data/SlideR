...
- `palette`: "Greens", "Set1", "Spectral" (1, 2, 3...).
- `direction`: 1 or -1.


## Color and fill scales

Scale function: **Brewer** ([web](https://colorbrewer2.org){target="_blank"}).
...
Arguments of the function^[`scale_xxx_gradient2()` includes `mid` and `midpoint`.]:
...
See [ggplot2](https://ggplot2.tidyverse.org/reference/theme.html){target="_blank"}
...
elecc19 |> 
  ...
  labs(title = "Vot a ERC i PSC a Catalunya, generals 2019",
