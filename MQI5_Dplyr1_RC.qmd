...
- Sempre s'ha de combinar amb una altra funció (e.g. `summarize`, `filter`, `mutate`), agrupa les dades segons els valors d'un o més vectors^[Aquest vector és normalment un vector de caràcter o un factor, però pot ser un altre vector amb poques categories (discret).]...
...
*Quan combinem group_by i summarize, estem canviant la __unitat d'observació__ del marc de dades.
