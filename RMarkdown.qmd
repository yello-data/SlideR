...
Establim uns paràmetres[^2] al YAML que al llarg del document podrem utilitzar com a codi.
...
Per referenciar^[En aquest [enllaç](https://bookdown.org/yihui/rmarkdown-cookbook/cross-ref.html){target="_blank"}, també podeu veure com es poden referenciar taules i marcs de dades] la secció del document: 
...
Ho farem normalment amb un document **BibTex** (`.bib`)^[Alguns paquets d'R com `RefManageR` automatitzen la gestió de cites.].
...
# RMarkdown avançat (chunks) {background-color="#e8e8e8"}
