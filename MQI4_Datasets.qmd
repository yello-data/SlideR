...
For strings, [`stringr`](https://stringr.tidyverse.org/){target="_blank"} [@R-stringr] | [Cheatsheet](https://www.rstudio.com/resources/cheatsheets/){target="_blank"}.
...
For factors, [`forcats`](https://forcats.tidyverse.org/){target="_blank"} [@R-forcats] | [Cheatsheet](https://www.rstudio.com/resources/cheatsheets/){target="_blank"}.


## Types of variables (2b): Ordinal {.scrollable}
...
## Types of variables (3b): Interval {.scrollable}
...
## Types of variables (4a): Ratio {.scrollable}
...
## Types of variables (4b): Ratio {.scrollable}
